    ...
    if(teban == '0'){
      ...
      // 150超え引き分け判定
          ...
          if('A' <= s[2] && s[2] <= 'Z'){ // 駒を打つ場合.
              ...
              if(f != 1){
                  printf("You Lose_husei3\n");
                  return 0;
              }
          }

          if(oute(ban, motigoma, 1)){
              printf("You Lose_oute\n");
              return 0;
          }
